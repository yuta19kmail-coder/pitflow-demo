    ...
    inspect: `
      ...
      <ul>
        ...
        <li>💴 <strong>「売上日と実績日で、月がちがう」（v1.185.0）</strong>＝<strong>伝票が立った月</strong>と
            ...
            直し方は2つ。<strong>伝票の日付が正しい</strong>なら「売上日」を直します（<strong>誰でも直せます・売上の数字は動きません</strong>）。
            <strong>返した日が正しい</strong>なら「実績カウント日」を直します（<strong>管理者だけ・締めた月の数字が動きます</strong>）。</li>
