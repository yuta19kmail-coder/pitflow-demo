  ...
  window.HELP_CONTENTS = {
    ...
    inspect: `
      ...
      <ul>
        ...
        <li>🔴 <strong>日付の前後には「起点日」があります（v1.173.0）。</strong>
            「返車予定日が入庫日より前」「実績の日が入庫日より前」は、<strong>その日より前に入庫した車では言いません</strong>
            （本番を始めた時に、8月頭からのぶんをまとめて入れたため）。<br>
            いまの起点日は<strong>画面のいちばん上に書いてあります</strong>。<strong>変えられるのは管理だけ</strong>です。</li>
