    ...
    inspect: `
      ...
      <ul>
        ...
        <li><strong>札を貼れます。</strong>
            <strong>見た</strong>＝目は通した。まだ決めていない（次も出ます）／
            <strong>これでOK</strong>＝見た。うちのやり方ではこれで正しい（次から出ません）／
            <strong>直した</strong>＝直した。<br>
            🔴 札は<strong>みんなで共有</strong>します（同じ車を2人で追いかけないため）。直したものは次のチェックで自然に消えます。</li>
        <li>1件ずつ「これでOK」を押すのが大変なくらい出ている時は、規則の説明の下の <strong>「この規則は出さない」</strong>で<strong>その規則まるごと</strong>黙らせられます（あとで「この規則をまた出す」で戻せます）。</li>
