...
(function () {
  ...
  window.HELP_CONTENTS = {
    ...
    save: `
      ...
      左上のロゴの右にある版（v1.77.0 など）の横に印が付いていれば練習用、
    ...
    newreserve: `
        ...
        <li><strong>入庫時間のショートカット（v1.33.0）</strong>＝<strong>AM／PM／朝一／お昼／夕方／決まり次第／レッカー／鍵ポスト／未定</strong>。
          ...
          <ul>
            ...
            <li>🔴 <strong>並び順は「いちばん遅くなり得る時刻」で決まります（v1.70.0）</strong>。
              <strong>朝一＝9:30／AM＝12時台のいちばん最後／お昼＝13:00／夕方・PM＝夕方の終わり</strong>（同じ終わりなら<strong>幅の広い PM が後ろ</strong>）。
              <em>9:00-10:00</em> のような範囲も<strong>後ろの 10:00</strong> で並びます。この時間は画面には出ません。</li>
            <li>🔴 <strong>枠（◯時台）も同じ物差しです（v1.70.0）</strong>。だから <strong>「AM」の車は 12:00 の枠</strong>に出ます（v1.69.0 までは 9:00 の枠でした）。朝一＝9時／お昼＝13時／夕方・PM＝18時の枠です。</li>
      ...
      <strong>「表紙印刷のみ」と、まっさらなカードの「印刷して保存」は今までどおり</strong>刷れます（予約は作りません）。</p>
    ...
    shaken: `
      ...
      <ul>
        ...
        <li><strong>決定</strong>：候補から1日を決定。ドラッグで別日に変更、予定エリアに戻すと候補に戻ります。</li>
