  ...
  window.HELP_CONTENTS = {
    ...
    shaken: `
      ...
      <ul>
        ...
        <li><strong>完了／再検</strong>：終わったら完了、再検があれば記録。
            🔴 <strong>再検には「落ちた理由」を1行だけ書けます</strong>（v2.54.0・空のままでもOK）。書いた内容は
            <strong>予約詳細の再検履歴</strong>に残り、この画面の「再2」のような印にカーソルを乗せても読めます。予約詳細の「再検を記録」からも同じ欄が出ます。</li>
        <li>🔴 <strong>記録したあとでも直せます</strong>（v2.55.0）。予約詳細の再検履歴は<strong>1本ずつ押せます</strong>。
            押すと、行った日・時間帯・担当・陸運局・R・理由を直す窓が出ます。
            <br>・<strong>「この再検の記録を取り消す」</strong>＝押し間違えた時。記録を消して、<strong>その日を「決定」に戻します</strong>（担当も戻ります）。
            　⚠ もう別の日で決め直している時・済んでいる時は、<strong>行く日は動かさず記録だけ消します</strong>。
            <br>・MHSの当日ビューで再検の行を押した時にも「この再検の記録を取り消す」が出ます。
            　⚠ 同じ日・同じ時間帯に記録が2つある時だけは、どちらか決められないので<strong>予約詳細から</strong>消してください。</li>
      </ul>
      <p>ヘッダーに「決定X／完了X／再検X／暫定X／候補X／未設定X」の件数が出ます。</p>
