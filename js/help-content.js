  ...
  window.HELP_CONTENTS = {
    ...
    inspect: `
      ...
      <ul>
        ...
        <li><strong>札は2つだけです（v1.172.0）。</strong>
            <strong>見た</strong>＝目は通した。まだ直っていない／
            <strong>直した</strong>＝直したつもり。<br>
            🔴 <strong>どちらを押しても、一覧からは消えません。</strong>
            本当に直っていれば<strong>次のチェックで自然に消えます</strong>。それが「直った」の答えです。<br>
