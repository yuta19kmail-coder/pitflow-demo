    ...
    inspect: `
      ...
      <ul>
        ...
        <li>🔴🔴 <strong>規則は2種類あります（v1.173.0）。</strong><br>
            ・<strong>抜け・矛盾</strong>（41本）＝金額が空・日付が空・状態が食い違う。<strong>直すしかありません</strong>（閉じる道はありません）。<br>
            ・<strong>要判断</strong>（7本・むらさきの「見て決める」の印）＝見積と確定が大きく違う／けたが小さい／返車がずっと先／
            お休みの日の予定／代車を先に返す／同じ番号で名前が違う／課と担当の課が違う。
